...
export default function ThirdPart({
  ...
  return (
    (thirdMedia || thirdPartTitle || thirdPartDescription) && (
      <section
        className={clsx(
          "flex flex-col gap-10 py-24 xl:gap-48 bg-neutral-100 dark:bg-neutral-900 lg:py-32 xl:py-48",
          {
      ...
      >
        ...
        <div className="relative grid grid-cols-12 px-6 gap-y-6 xl:gap-y-40 lg:px-20">
          {thirdPartDescription && (
            <p
              className={clsx(
                "col-span-12 col-start-1 text-xl sm:text-2xl xl:col-span-3 xl:col-start-2 text-neutral-600 dark:text-neutral-400",
                {
          ...
          {thirdMedia && (
            <div className="relative col-span-12 col-start-1 xl:col-start-6 xl:col-span-6">
              <Media
                type={thirdMedia.type}
                url={thirdMedia.url}
                name={thirdMedia.name}
              />
            </div>
          )}
        </div>
