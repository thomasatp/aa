  ...
  return (
    <section className="relative grid grid-cols-12 px-6 pb-24 mt-10 xl:mt-20 xl:pb-48 max-xl:gap-y-12 lg:px-20">
      <div className="col-span-12 col-start-1 xl:col-start-2 xl:col-span-2">
        <div className="flex flex-wrap items-start gap-2 text-xl font-semibold xl:flex-col">
          {tags.map((tag, i) => (
            <p
      ...
      <div className="col-span-12 col-start-1 xl:col-start-4 xl:col-span-6">
        ...
        {link && (
          <a
            href={link}
            target="_blank"
            className="flex items-end gap-2 mt-12 text-xl font-bold leading-6 cursor-pointer group xl:mb-12 dark:text-white text-neutral-950"
          >
