...
export default function PeopleTile({ name, job, media }: PeopleProps) {
  ...
  return (
    <div
      ref={ref}
      className={clsx(`relative col-span-6 xl:col-span-4 2xl:col-span-3`, {
    ...
    >
      ...
      <div className="flex flex-col items-baseline mt-4">
        ...
        <div className="flex flex-wrap gap-1 mt-3">
          <p className="px-3 py-1 text-sm transition-all duration-300 border rounded-full dark:border-neutral-600 dark:text-neutral-500 border-neutral-400 text-neutral-500">
            {job}
          </p>
        </div>
      </div>
