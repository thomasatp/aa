...
export default function Baseline() {
  ...
  return (
    <motion.div style={{opacity}} className="flex overflow-hidden absolute top-10 w-96 max-w-full h-7 text-lg font-medium lg:top-12 lg:flex-row text-neutral-400">
