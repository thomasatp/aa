...
export default function Header({ title, img }: { title: string; img: string }) {
  return (
    <section className="relative z-10 grid grid-cols-12 gap-8 px-0 py-0 mt-0 lg:mt-48 lg:px-20">
      ...
      <h1 className="relative lg:absolute px-6 lg:px-0 lg:left-0 lg:right-0 z-10 lg:bottom-8 col-start-1 xl:col-start-2 col-span-12 xl:col-span-10 leading-[0.8] font-semibold mb-4 text-[16vw] break-words xl:text-[14vw]">
        {title}
      </h1>
    </section>
  );
