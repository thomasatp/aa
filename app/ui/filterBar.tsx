  ...
  return (
    ...
    >
      <Link
        ...
        scroll={false}
        className={clsx(
          "flex flex-none px-4 py-2 text-sm rounded-full border transition-all duration-300 cursor-pointer snap-start will-change-auto border-neutral-800 text-neutral-600 dark:border-neutral-400 dark:text-neutral-400",
          {
            "text-white bg-neutral-800 dark:bg-neutral-400 dark:text-neutral-950":
              !filter,
